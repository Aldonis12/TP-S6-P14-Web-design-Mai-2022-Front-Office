...
public class ArticleService {
    ...
    public static String GetTempsApres(LocalDateTime date) {
        ...
        LocalDateTime plus3Hours = now.plusHours(3);
        Duration duration = Duration.between(date, plus3Hours);
    ...
    public List<Actualite> Actualite(){
        ...
        for (Object[] result : results) {
            ...
            if (date instanceof Timestamp) {
                ...
                String formattedDate = localDateTime.format(DateTimeFormatter.ofPattern("EEEE d MMMM yyyy", Locale.FRENCH));
