...
<%@ page import="miniprojet.miniprojet.Model.Favoris" %><%--
...
<%
    List<Favoris> list = (List<Favoris>) request.getAttribute("liste");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="Mes favoris - Informations sur l’intelligence artificielle">
    <title>Mes favoris - Informations sur l’intelligence artificielle</title>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="row align-items-center mb-4">
                        <div class="col">
                            <h2 class="h5 page-title">Mes favoris</h2>
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-md-9">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <strong class="card-title"><%=p.getArticle().getTitre()%></strong>
                                </div>
                                <div class="card-body">
                                    <div class="row align-items-center mb-4">
                                        <div class="col">
                                            <div class="mb-2"><%=p.getArticle().getContenu()%></div>
                                            <small class="text-muted"><%=p.getArticle().getDatepublication()%></small>
                                        </div>
                                        <div class="col-auto">
                                            <form action="<%=request.getContextPath()%>/DislikeArticle" method="post">
                                                <input type="hidden" name="idArticle" value="<%=p.getArticle().getIdArticle()%>">
                                                <input type="hidden" name="idUser" value="<%= request.getAttribute("id")%>">
                                                <button type="submit" class="circle circle-sm bg-light-lighter fe fe-thumbs-down" title="Supprimer des favoris"> </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
