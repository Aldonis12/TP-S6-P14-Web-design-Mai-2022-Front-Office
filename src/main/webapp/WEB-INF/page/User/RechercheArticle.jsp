            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="row align-items-center mb-4">
                        <div class="col">
                            <h2 class="h5 page-title">Liste des articles</h2>
                        </div>
                    </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center mb-4">
                                        ...
                                        <div class="col-auto">
                                            <form>
                                                <input type="hidden" id="idArticle" value="<%=p.getIdArticle()%>">
                                                <input type="hidden" id="idUser" value="<%= request.getAttribute("id")%>">
                                            </form>
                                            <a onclick="addLike()">
                                      <span class="circle circle-sm bg-light" title="J'adore">
...
<script>
    function addLike(){
        ...
        formActuStatus.append('idArticle',document.getElementById("idArticle").value);
        formActuStatus.append('idUser',document.getElementById("idUser").value);
        fetch('<%=request.getContextPath()%>/LikeArticle', {
            method: 'POST',
            body: formActuStatus
        });
    }
